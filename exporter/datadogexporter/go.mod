...
require (
	...
	github.com/DataDog/datadog-agent/pkg/trace v0.39.0-rc.6
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.39.0-rc.6 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.39.0-rc.6 // indirect
